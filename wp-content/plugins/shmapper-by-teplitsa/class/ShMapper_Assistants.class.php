...
class ShMapper_Assistants
{
    ...
    public static function ba_admin_posts_filter($query)
    {
    ...
    public static function ba_admin_posts_filter_restrict_manage_posts()
    {
    ...
    public static function shm_after_request_form($text)
    {
    ...
    public static function shm_after_request_form2($text)
    {
        //SESSION if session-plugin active
        if (!shm_is_session() || !$_SESSION) {
            return $text;
        }
