...
class ShMaperTrack extends SMC_Post
{
    ...
    public static function shm_admin_element($html, $id, $data)
    {
    ...
    public function draw($params=["height"=>400, "show_markers" => true])
    {
        if (ShMapper::$options['map_api'] != 1) {
    ...
    public static function smc_post_fill_views_column($html, $column_name, $post_id, $obj, $meta)
    {
    ...
    */
    public static function smc_post_admin_edit($html, $meta, $obj, $key, $value)
    {
        if ($value['type'] == "gpx") {
            $html = "<div>
    ...
    public static function get_dump($data)
    {
        ob_start();
        var_dump($data);
    ...
    public static function shm_before_insert_request($arr, $data)
    {
        //var_dump( $arr );
        //var_dump( $data );
        //wp_die(  );
    ...
    public static function shmapper_get_form_fild_types($arr)
    {
        $arr[] = [
    ...
    */
    public static function shmapper_front_form_element($html1, $element)
    {
    ...
    public static function shmapper_form_after_fields($html, $id, $data, $type)
    {
