...
class ShmForm
{
    ...
    public static function get_type_by($field="id", $id = 1)
    {
    ...
    public static function wp_params_dropdown($meta, $id, $selected = -1)
    {
    ...
    public static function wp_params_radio($params=-1, $id, $post_id=1)
    {
    ...
    public static function get_admin_element($id, $data=-1)
    {
    ...
    public static function form($data, $map)
    {
    ...
    public static function getTypeSwitcher(
        $element,
        $map,
        $require,
        $params=[
