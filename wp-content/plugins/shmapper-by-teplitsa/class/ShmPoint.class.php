...
class ShmPoint extends SMC_Post
{
    ...
    public static function update_map_owners($obj)
    {
        global $wpdb;
    ...
    public static function bulk_owner_fields_edit($params=-1, $type="radio")
    {
        $all = ShmMap::get_all(-1, -1, 0, 'title', 'ASC');
    ...
    public static function get_insert_form($data)
    {
        // 0 - map_id
        // 1 - x
        // 2 - y
    ...
    public function remove_from_map($map_id)
    {
        global $wpdb;
        $query = "DELETE FROM " . $wpdb->prefix . "point_map 
    ...
    public function add_to_map($map_id)
    {
        global $wpdb;
        $query = "DELETE FROM " . $wpdb->prefix . "point_map 
		WHERE map_id=$map_id AND point_id=$this->id;";
    ...
    public function get_owner_list($before = "", $separator = "<br>", $after = "")
    {
    ...
    public static function save_bulk_edit_point()
    {
