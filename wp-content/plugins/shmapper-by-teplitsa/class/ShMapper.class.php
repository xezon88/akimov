...
class ShMapper
{
    ...
    public static function my_admin_bar_render()
    {
    ...
    public static function init_obj($init_object)
    {
        if (!is_array($init_object)) {
            $init_object = [];
        }
        $point						= [];
        $point['t']					= ['type'=>'post'];
    ...
    public static function add_admin_js_script()
    {
        $locale = get_locale();
        //css
        ...
        } elseif (static::$options['map_api'] == 2) {
            //css
    ...
    public static function add_frons_js_script()
    {
        $locale = get_locale();
        $ymap_key = '';
        if (isset(ShMapper::$options['shm_yandex_maps_api_key'])) {
    ...
    public static function admin_page_handler()
    {
        /**/
        add_menu_page(
    ...
    public static function admin_page_handler2()
    {
        add_submenu_page(
            'shm_page',
            __("Settings"),
    ...
    public static function add_wizzard()
    {
    ...
    public static function get_wizzard_lst()
    {
        return [
            [
