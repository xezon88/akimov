...
class ShMapperDriverPreview
{
    ...
    public static function update()
    {
        ...
        foreach ($matrix as $m) {
            ...
            if ($i > 0) {
                ...
                if (count($copies) > 0) {
                    if (ShMapperDrive::$options["shm_doubled"] == 0) {
                        continue;
                    }
                    // point type
                    if (ShMapperDrive::$options['is_google_point_type']) {
    ...
    public static function getGeoPosition($m)
    {
    ...
    public static function geocode($address)
    {
        ...
        $address = $location["response"]["GeoObjectCollection"]["featureMember"]["GeoObject"]["metaDataProperty"]["GeocoderMetaData"]["text"];
        $location = $location["response"]["GeoObjectCollection"]["featureMember"]["GeoObject"]["Point"]["pos"];
