...
class ShmMap extends SMC_Post
{
    ...
    public static function get_osm_types()
    {
        return [
            "Topographic",
            "Streets",
    ...
    public static function shortcode_fields()
    {
    ...
    public static function shortcode_fields_box_func($post)
    {
        $lt = static::get_instance($post);
        echo static::shortcode_fields_edit($lt);
    }
    public static function shortcode_fields_edit($obj)
    {
        $html = '
    ...
    public static function my_form_fields()
    {
    ...
    public static function form_fields_box_func($post)
    {
        $lt = static::get_instance($post);
        echo static::view_form_fields_edit($lt);
    }
    public static function view_form_fields_edit($obj)
    {
    ...
    public static function smc_before_doubled_post($metas, $smc_post)
    {
        if ($smc_post->get("post_type") !== ShmPoint::get_type()) {
            return $metas;
        }
    ...
    public static function smc_after_doubled_post($new_smc_post, $origin_smc_post)
    {
        global $wpdb;
        if ($origin_smc_post->get("post_type") !== static::get_type()) {
            return;
        }
    ...
    public static function formEditor($data)
    {
        $html 	= "
    ...
    public function get_include_types()
    {
    ...
    public function get_points_args()
    {
        global $wpdb;
    ...
    public function get_point_count()
    {
        $point_count = count((array) $this->get_points_args());
        return $point_count;
    }
    public function get_delete_form($href)
    {
        $html ="
    ...
    public function draw($args=-1)
    {
        if (!is_array($args)) {
            $args = [ "height" => 450, "id" => $this->id, "is_title" => 'true' ];
        }
    ...
    */
    public function shm_delete_map_hndl($data)
    {
        global $wpdb;
        $points = $this->get_points();
        switch ($data['action']) {
    ...
    public static function get_type_radio($params=-1)
    {
        if (!is_array($params)) {
            $params = [
                "id" 		=> "map_radio",
