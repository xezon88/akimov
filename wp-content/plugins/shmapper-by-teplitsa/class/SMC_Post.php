 ...
 */
    ...
    class SMC_Post
    {
        ...
        public function update_metas($meta_array)
        {
            $data	= array();
        ...
        */
        public static function get_all($metas=-1, $numberposts=-1, $offset=0, $order_by='title', $order='DESC', $order_by_meta="", $fields="all", $relation="AND", $author=-1)
        {
            $args		= array(
        ...
        public static function get_all_count($args=-1)
        {
            if (is_array($args)) {
                $args["numberposts"] = -1;
                $args['fields'] = "ids";
        ...
        public static function get_all_ids($metas=-1, $numberposts=-1, $offset=0, $order_by='title', $order='DESC', $is_update=false)
        {
            $args		= array(
                                    "numberposts"		=> $numberposts,
        ...
        */
        public static function amount_meta($meta_key, $post_ids=-1)
        {
        ...
        */
        ...
        public static function dropdown($data_array, $params="-1")
        {
            if (!is_array($params)) {
                $params	= array();
            }
        ...
        public static function fill_views_column($column_name, $post_id)
        {
        ...
        public static function add_views_sortable_column($sortable_columns)
        {
            return $sortable_columns;
        }
        
        // change the query when sorting a column
        public static function add_column_views_request($object)
        {
        }
        
        // bulk actions
        public static function register_my_bulk_actions($bulk_actions)
        {
        ...
        public static function my_bulk_edit_custom_box($column_name, $post_type)
        {
            if ($post_type != forward_static_call_array(array( get_called_class(),"get_type"), array())) {
                return;
            }
            /**/
            global $wp_db, $post_id;
        ...
        public static function save_bulk_edit_book()
        {
                    ...
                    foreach ($obj as $key => $value) {
                        ...
                        switch ($obj[$key]['type']) {
                            ...
                            case "date":
                                ...
                                break;
                            case "boolean":
                                if (!isset($_POST['smc_post_changer'][ $key ])  || (int)$_POST['smc_post_changer'][ $key ] < 0) {
                                    break;
                                }
        ...
        public static function get_extra_fields_title()
        {
            return __('Parameters', SHMAPPER);
        }
        
        public static function my_extra_fields()
        {
        ...
        public static function extra_fields_box_func($post)
        {
        ...
        public static function true_save_box_data($post_id)
        {
        ...
        public static function view_admin_edit($obj)
        {
            require_once(SHM_REAL_PATH."class/SMC_Object_type.php");
            $html = '';
            $SMC_Object_type	= SMC_Object_Type::get_instance();
        ...
        public static function save_admin_edit($obj)
        {
            return array();
        }
    }
