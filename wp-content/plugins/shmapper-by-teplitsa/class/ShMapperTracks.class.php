...
class ShMapperTracks
{
    ...
    public static function shm_shortcode_args($arr, $args)
    {
    ...
    public static function shm_after_front_map($html, $args)
    {
    ...
    public static function shm_voc($arr)
    {
        $arr = array_merge(
            $arr,
            [
    ...
    public static function shm_vocabulary($arr)
    {
        $arr = array_merge(
            $arr,
            [
